...
const strings = {
  ...
  childNamePlaceholder: { ar: 'مثلاً: نور', en: 'e.g. Noor' },
  childGenderLabel: { ar: 'نوع الطفل', en: "Child's gender" },
  requiredLabel: { ar: 'مطلوب', en: 'Required' },
  genderMale: { ar: 'ذكر', en: 'Male' },
  genderFemale: { ar: 'أنثى', en: 'Female' },
  childGenderHint: { ar: 'بنستخدم الاختيار ده علشان نخاطب طفلك بصيغة صحيحة في كل أجزاء التطبيق.', en: 'This helps the app use the right words for your child throughout the experience.' },
  genderRequiredError: { ar: 'اختاري نوع الطفل علشان نكمّل.', en: "Choose the child's gender to continue." },
  birthDateLabel: { ar: 'تاريخ الميلاد', en: 'Date of birth' },
  birthDateHint: { ar: 'اختاري اليوم والشهر والسنة', en: 'Choose the day, month, and year' },
  birthDayLabel: { ar: 'اليوم', en: 'Day' },
  birthMonthLabel: { ar: 'الشهر', en: 'Month' },
  birthYearLabel: { ar: 'السنة', en: 'Year' },
  chooseBirthDate: { ar: 'اختاري تاريخ الميلاد', en: 'Choose date of birth' },
  datePickerDone: { ar: 'تم', en: 'Done' },
  ...
  defaultBoyName: { ar: 'طفلي', en: 'my child' },
  defaultGirlName: { ar: 'طفلتي', en: 'my child' },
  completeProfileTitle: { ar: 'كمّلي بيانات طفلك', en: "Complete your child's profile" },
  completeProfileSubtitle: { ar: 'اختاري نوع الطفل مرة واحدة علشان كل النصائح والمتابعة تظهر بصيغة صحيحة. بياناتك القديمة محفوظة زي ما هي.', en: "Choose the child's gender once so every tip and update uses the right wording. Your existing data is still safe." },
  completeProfileCta: { ar: 'حفظ ومتابعة', en: 'Save and continue' },
